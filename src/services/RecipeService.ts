...
class RecipeService {
  ...
  removeCommandFromRecipe(
    recipeId: string,
    commandId: string,
    index: number
  ): Promise<any> {
    return http.delete(
      'jobs/recipe/removeCommandFromRecipe/' +
        recipeId +
        '/' +
        commandId +
        '/' +
  ...
  getByDeviceType(
    ...
    return http.get(
      'jobs/recipe/getByDeviceType/' + type + '/' + sortBy + '/' + sortDirection
    );
  }

  getByDeviceTypeAndPages(
    type: string,
    page: number,
    pageSize: number,
    sortBy: string,
    ...
    return http.get(
      'jobs/recipe/getByDeviceTypeAndPages/' +
        type +
        '/' +
        page +
        '/' +
  ...
  removeSubRecipeFromRecipe(
    ...
    return http.delete(
      'jobs/recipe/removeSubRecipeFromRecipe/' +
        recipeId +
        '/' +
        subRecipeId +
        '/' +
  ...
  getAllRecipesPageable(
    ...
    return http.get(
      'jobs/recipe/getAllRecipesPageable/' +
        page +
        '/' +
        pageSize +
        '/' +
  ...
  getFullRecipesByDeviceType(
    deviceType: string,
    sortBy: string,
    sortDirection: string
  ): Promise<any> {
    return http.get(
      'jobs/recipe/getFullRecipesByDeviceType/' +
        deviceType +
        '/' +
        sortBy +
        '/' +
  ...
  getFullRecipesByDeviceTypeAndPages(
    deviceType: string,
    page: number,
    pageSize: number,
    sortBy: string,
    ...
    return http.get(
      'jobs/recipe/getFullRecipesByDeviceTypeAndPages/' +
        deviceType +
        '/' +
        page +
        '/' +
  ...
  getSubRecipes(
    ...
    return http.get(
      'jobs/recipe/getSubRecipesByDeviceType/' +
        deviceType +
        '/' +
        sortBy +
        '/' +
